...
function get_todos() {
    ...
    // communicate with the web browser to make the tasks a JS object
    if (todos_str !== null) {
...
function add() {
    ...
    var todos = get_todos();
    // this adds a new tasks to the end of the array
    todos.push(task);
...
function show() {
    ...
    // this sets up each tasks as a unordered list
    var html = '<ul>';
