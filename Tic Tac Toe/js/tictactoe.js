...
function placeXorO(squareNumber) {
    ...
    // This conditoin checks to see if it computers turn
    if(activePlayer === 'O') {
...
function computersTurn() {
    ...
    while(!success) {
        ...
        // If a random number evaluates returns true, the square hasn't been selected yet
...
function checkWinConditions() {
    ...
    // andd 9 squares are selected, the code executes.
    else if (selectedSquares.length >= 9) {
        // This function plays the tie game sound.
        audio('./media/attack_the_objective.mp3');
        // This functoin sets a .3 second timer before the resetGame is called.
    ...
    function arrayIncludes(squareA, squareB, squareC) {
        ...
        // returned and our else if condition execurres the drawWinLine function
